...
incube = fits.open(direc + "/cube_smoothspace_final_v2.fit") #cube with smooth spectra
...
#
#ax1.hlines(0,xmin=0,xmax=5,label="zero",color='darkblue',linewidth=1.)                 #zero line
...
ax1.plot(wave_h,contin_hline,color="red")   #the continuum under h2o
ax1.plot(wave_c,contin_cline,color="red",label="continuum")   #the continuum under co2
