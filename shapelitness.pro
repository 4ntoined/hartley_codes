...
;
pro shapelitness,jd,litness,h2orient=h2orient,printmess=printmess
;Inputs, jd 		- julian date of observation
;	 h2orient 	- what rotation period to use for H2
;
;Outputs,litness 	- hpw bright the shape model appears to the observer
;
...
;print,""
;print,conn[0:11]
model_display,vert,conn,xpos,zpos,obspos,sunpos,ncp_ca,geom_ret=geom_ret,amv_rd=amv_rd, /axes
;xpos,
;ncp_ca
...
litness = total(seeing)

if printmess then begin
help,geom_ret
...
print,seeing[0:10]
print,"Litness of the shape @ "+jd+': ',litness
endif
